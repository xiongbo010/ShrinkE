...
from models.models_box import ShrinkE
...
if __name__ == "__main__":
    ...
    if config['DATASET'] == 'jf17k' or config['DATASET'] == 'wikipeople' or config['DATASET'] == 'wikipeople50':
    ...
    if config['MODEL_NAME'].lower().startswith('stare'):
        ...
        elif config['MODEL_NAME'].lower().endswith('shrinking_fc'):
            model = ShrinkE(config)
            # model = IntersectionE(config)
        else:
